# Generated by Django 4.0.4 on 2022-07-20 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S5', 'SEMESTER FIVE'), ('S6', 'SEMESTER SIXTH')], max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='OrderPlaced',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prodcut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
